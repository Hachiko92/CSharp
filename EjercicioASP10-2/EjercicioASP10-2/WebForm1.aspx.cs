...
namespace EjercicioASP10_1
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void sqlEmployees_Updated(object sender, SqlDataSourceStatusEventArgs e)
        {
            result.InnerHtml = "Registo actualizado";
        }

        protected void sqlEmployees_Updating(object sender, SqlDataSourceCommandEventArgs e)
        {
            result.InnerHtml = "";
        }
    }
